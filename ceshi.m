...
tic;
data_source = dlmread('G:\2015_Autumn\±ÏÉè\¿ìËÙÂ·ÌáÈ¡\´¦ÀíºóÍâ»·gaode_2015_11_1.txt');
toc;
...
mif_folder = 'g:\transport_research\¿ÉÔ¤²âÐÔ\Â·¶ÎÑ¡Ôñ\Â·¶Î·ÖÏòÑ¡Ôñ\';
mid_cnum = [1,3,4,5,6];	
...
@g:\transport_research\¿ÉÔ¤²âÐÔ\¸ßµÂÈ«ÄêÊý¾Ý\oracle2csv.sql;
