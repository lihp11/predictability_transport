...
weather = xlsread('g:\2015_Autumn\transport_research\可预测性\一季度天气.xlsx',1,'B1:B64');
weather = flipud(weather);
disp('天气数据读取完毕');

bj_city_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',1,'E2:E63'); 
tj_city_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',1,'E2186:E2247');
bj_city_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',1,'F2:F63'); 
tj_city_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',1,'F2186:F2247'); 
bj_city_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',1,'G2:G63'); 
tj_city_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',1,'G2186:G2247'); 
disp('北京天津城市交通指标读取完毕！');


tj_urban_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',2,'C2:C63'); 
tj_urban_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',2,'D2:D63'); 
tj_urban_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',2,'E2:E63'); 
disp('天津城六区交通指标读取完毕！');

tj_heping_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'F2:F63'); 
tj_heping_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'G2:G63'); 
tj_heping_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'H2:H63'); 
disp('天津和平区交通指标读取完毕！');

tj_hebei_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'F8737:F8798'); 
tj_hebei_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'G8737:G8798'); 
tj_hebei_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'H8737:H8798'); 
disp('天津河北区交通指标读取完毕！');

tj_hedong_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'F2185:F2246'); 
tj_hedong_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'G2185:G2246'); 
tj_hedong_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'H2185:H2246'); 
disp('天津河东区交通指标读取完毕！');

tj_hexi_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'F4369:F4430'); 
tj_hexi_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'G4369:G4430'); 
tj_hexi_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'H4369:H4430'); 
disp('天津河西区交通指标读取完毕！');

tj_hongqiao_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'F10921:F10982'); 
tj_hongqiao_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'G10921:G10982'); 
tj_hongqiao_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'H10921:H10982'); 
disp('天津红桥区交通指标读取完毕！');

tj_nankai_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'F6553:F6641'); 
tj_nankai_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'G6553:G6641'); 
tj_nankai_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',3,'H6553:H6641'); 
disp('天津南开区交通指标读取完毕！');

tj_freeway_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',4,'C2:C63'); 
tj_freeway_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',4,'D2:D63'); 
tj_freeway_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',4,'E2:E63'); 
disp('天津快速路交通指标读取完毕！');

tj_outring_vf = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',5,'C2:C63'); 
tj_outring_vm = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',5,'D2:D63'); 
tj_outring_conjestion_index = xlsread('g:\2015_Autumn\transport_research\可预测性\天津季度报告数据需求.xlsx',5,'E2:E63'); 
disp('天津外环交通指标读取完毕！');
rand_num = rand(1,61);
fix_num = ones(1,61);
indicator_cell = {stock,...
    ...
    rand_num,fix_num,...
    weather}'; %行数=指标类型数量,列数=1,内容=各指标vector（列向量）
