...
function param = vec2unreliability(vector,n,interval,alpha)
	% vector: travel time vector (mainly tod/dow vecotr)
	% n:num of distinct symbols
	% interval: distance of string to get a special predicction
	% alpha: used for calc f7:factor of tt50
	string = vector_to_string(vector,n);
	% string: char vector
